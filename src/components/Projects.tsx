...
export default function Projects() {
    ...
    useEffect(() => {
        // Set inView to true by default to ensure everything is visible
        setInView(true);
                ...
                >
                    <Card className="flex flex-col shadow-lg hover:shadow-2xl transition-shadow duration-300 mt-5">
                        ...
                        <div className="flex flex-col md:flex-row w-full">
                            ...
                            {/* Content - Below image in mobile, on left in desktop */}
                                ...
                                <CardContent className="p-0 space-y-2">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {project.tech.map((techItem, i) => (
                                            <Badge key={i} variant="secondary" className="px-2 py-1 text-xs rounded-full bg-[var(--brown)] text-white font-medium">
                                                {techItem}
                                            </Badge>
                                        ))}
                                    </div>
